//package com.hand.core.db

import com.hand.hap.liquibase.MigrationHelper

//表结构
databaseChangeLog(logicalFilePath: "com/hand/core/db/liquibase.groovy") {
    ...
    migrationHelper.dbmigrate(dbType,["com/hand/hap","com/hand/core"] ,["table", "data", "patch"])
